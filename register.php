...
<head>
    ...
    <meta name="description" content="Hoslink-hostel website">
...
<body id="register_bg">
	...
	<div id="login">
		<aside>
			<figure>
				<a href="index.html"><img src="img/hoslinklogo.jpg" alt= HosLink width="160" height="50" alt="" class="logo_sticky"></a>
			</figure>
