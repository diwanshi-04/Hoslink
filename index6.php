	...
	<main class="pattern">
		<section class="hero_single version_2">
			<div class="wrapper">
				<div class="container">
					...
					<p>Discover top rated hostels, hotels, shops and restaurants around your City</p>
		...
		<div class="main_categories">
			<div class="container">
				<ul class="clearfix">
				<li>
						<a href="grid-listings-filterscol.php">
		...
		<div class="container margin_60_35">
			<div class="main_title_3">
				...
				<h2>Famous Shops</h2>
				<p>Famous Shops.</p>
				<a href="grid-listings-filterscol.php">See all</a>
			</div>
			<div class="row add_bottom_30">
				<div class="col-lg-3 col-sm-6">
					<a href="detail-shop.php" class="grid_item small">
						<figure>
							<img src="img/shop_1.jpg" alt="">
							<div class="info">
								<h3>Tradition Secretes</h3>
							</div>
						</figure>
					</a>
				</div>
			...
			<div class="row add_bottom_30">
				<div class="col-lg-3 col-sm-6">
					<a href="detail-hotel.php" class="grid_item small">
						<figure>
			...
			<div class="row ">
				<div class="col-lg-3 col-sm-6">
					<a href="detail-restaurant.php" class="grid_item small">
						<figure>
							<img src="img/restaurant_1.jpg" alt="">
							<div class="info">
								<h3>The Indian Serves </h3>
							</div>
						</figure>
					</a>
				</div>
		...
		<div class="call_section">
			<div class="wrapper">
				<div class="container margin_80_55">
					...
					<div class="row">
						<div class="col-md-4">
							<div class="box_how">
								...
								<p>You can search your location.</p>
								<span></span>
							</div>
						</div>
						<div class="col-md-4">
							<div class="box_how">
								...
								<p>find the service nearby your location.</p>
								<span></span>
							</div>
						</div>
						<div class="col-md-4">
					...
					<!-- /row -->
					<p class="text-center add_top_30 wow bounceIn" data-wow-delay="0.5s"><a href="account.php" class="btn_1 rounded">Register Now</a></p>
				</div>
