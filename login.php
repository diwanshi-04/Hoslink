...
<head>
    ...
    <meta name="author" content="Diwanshi">
    <title>HOSLINK</title>
...
<body id="login_bg">
	...
	<div id="login">
		<aside>
			<figure>
				<a href="index.html"><img src="img/hoslinklogo.jpg" width="150" height="60" alt="" class="logo_sticky"></a>
			</figure>
			  <form>
				...
				<div class="text-center add_top_10">New to HosLink? <strong><a href="register.html">Sign up!</a></strong></div>
			</form>
			<div class="copy">© 2024 HosLink</div>
		</aside>
	</div>
	<!-- /login -->
